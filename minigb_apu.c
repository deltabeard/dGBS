...
static uint_fast16_t nsamples;
#define AUDIO_NSAMPLES (nsamples)
...
uint_fast16_t set_tma_tac(const uint8_t tma, const uint8_t tac)
{
	...
	nsamples   = (AUDIO_SAMPLE_RATE / audio_rate) * 2;
	return nsamples;
}
